...
| -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |ReleaseTimeWindow| 若故障已经恢复，并持续超过ReleaseTimeWindow的时间窗没有再发生该故障。该参数的取值范围为60~uint32最大值，单位为秒。若不配置该参数，则表示策略升级后不降级。由于ManuallySeparateNPU支持手工解除，所以除了ManuallySeparateNPU，其余处理策略必须配置该参数，防止故障恢复后设备永远无法使用。                                                                                                                                                                                                                                                                                           |
